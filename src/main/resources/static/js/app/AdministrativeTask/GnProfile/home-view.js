...
var GnProfileHome = function () {
    ...
    var runDataTable = function () {
        var assetTable = $('#tbl_basic_gn_profile').DataTable({
            "bAutoWidth": false,
            "processing": true,
            "serverSide": true,
            "ajax": $.fn.dataTable.pipeline( {
                url: "../restapi/basicgnprofile/",
                pages: 5
            } ),
            columns : [ {
                orderable: false,
            ...
            aoColumnDefs: [{
                ...
                render: function ( data, type, full, meta ) {
                    return "<div align='center'>" + ButtonUtil.getHomeBtnWithURL("basicgnprofile", data);
                }
            }],
            oLanguage: {
                sLengthMenu: " _MENU_",
